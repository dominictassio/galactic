...
class __Mustache_c441864091d3e41256db676a476bb199 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE34b7b0128e0d143f7d84a0bd111c01a($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function sectionE34b7b0128e0d143f7d84a0bd111c01a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                    <img class="col-xs-1 img-rounded img-responsive" src="https://minotar.net/avatar/{{ name }}" alt="{{ name }}">
                ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                    <img class="col-xs-1 img-rounded img-responsive" src="https://minotar.net/avatar/';
