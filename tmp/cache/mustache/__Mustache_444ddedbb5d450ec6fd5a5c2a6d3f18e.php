...
class __Mustache_444ddedbb5d450ec6fd5a5c2a6d3f18e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section283f7a016a08af096b9c3d0ea298e3d0($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function section283f7a016a08af096b9c3d0ea298e3d0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
<!--                     <img class="img-rounded img-responsive" src="https://minotar.net/avatar/" alt=""> -->
                    <b>{{ name }}</b>
                ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<!--                     <img class="img-rounded img-responsive" src="https://minotar.net/avatar/" alt=""> -->
';
                $buffer .= $indent . '                    <b>';
