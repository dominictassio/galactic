...
class __Mustache_2f099712b228d78b2b19d364038f0fcf extends Mustache_Template
{
...
';
        $buffer .= $indent . '                <a class="navbar-brand" href="#">Galactic.ga</a>
';
        $buffer .= $indent . '            </div>
';
...
';
        $buffer .= $indent . '            <h1>Galactic.ga\'s FTB Infinity Server</h1>
';
...
';
        ...
        $buffer .= $this->sectionE02346c24bf7091618dadc4ad717c2c0($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
        $buffer .= $indent . '            $(\'[data-toggle="tooltip"]\').tooltip()
';
        $buffer .= $indent . '        });
';
        $buffer .= $indent . '    </script>
...
';
    ...
    private function sectionE02346c24bf7091618dadc4ad717c2c0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                    <div class="col-xs-1">
                        <img class="img-responsive" src="https://minotar.net/helm/{{ name }}" alt="{{ name }}" data-toggle="tooltip" data-placement="bottom" data-html="{{ name }}">
                    </div>
                ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
...
';
                $buffer .= $indent . '                        <img class="img-responsive" src="https://minotar.net/helm/';
                $value = $this->resolveValue($context->find('name'), $context, $indent);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= '" alt="';
                $value = $this->resolveValue($context->find('name'), $context, $indent);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= '" data-toggle="tooltip" data-placement="bottom" data-html="';
                $value = $this->resolveValue($context->find('name'), $context, $indent);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= '">
';
