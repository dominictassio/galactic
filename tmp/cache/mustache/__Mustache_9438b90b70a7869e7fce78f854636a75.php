...
class __Mustache_9438b90b70a7869e7fce78f854636a75 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAb993a1d952f55d90c7d062d135152c2($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function sectionAb993a1d952f55d90c7d062d135152c2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                    <div class="col-xs-1">
                        ...
                        <span clas="text-center">{{ name }}</span>
                    </div>
                ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
...
';
                ...
                $buffer .= '">
';
                $buffer .= $indent . '                        <span clas="text-center">';
                $value = $this->resolveValue($context->find('name'), $context, $indent);
                $buffer .= htmlspecialchars($value, 2, 'UTF-8');
                $buffer .= '</span>
';
