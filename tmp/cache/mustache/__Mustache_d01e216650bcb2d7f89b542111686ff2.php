...
class __Mustache_d01e216650bcb2d7f89b542111686ff2 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6521183e4e96ec47423e54487b5c851f($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function section6521183e4e96ec47423e54487b5c851f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                    <img class="col-xs-3 img-rounded img-responsive" src="https://minotar.net/avatar/{{ name }}" alt="{{ name }}">
                ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                    <img class="col-xs-3 img-rounded img-responsive" src="https://minotar.net/avatar/';
