...
class __Mustache_2db5f8100733f07b0176394abe436b04 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF82d0ca11e4f8ba352e1b8b5516f2e5d($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
...
';
    ...
    private function sectionF82d0ca11e4f8ba352e1b8b5516f2e5d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
                    <img class="img-rounded img-responsive" src="https://minotar.net/avatar/{{.}}" aslt="{{.}}">
                ';
